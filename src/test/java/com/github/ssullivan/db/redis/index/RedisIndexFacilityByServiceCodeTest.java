...
public class RedisIndexFacilityByServiceCodeTest extends AbstractRedisIndexTest {
  @Test
  public void indexLocationByServiceCodeInvalidFacilityId() throws IOException {
    try {
      final IndexFacilityByServiceCode index = injector.getInstance(IndexFacilityByServiceCode.class);
